class carrinhoCompras {
    ...
    #validarAdicao(preco) {
        ...
        if (this.#calcularTotal() + preco > this.#valorMaximo) {
            console.log(`Valor máximo de R$ ${this.#valorMaximo} foi ultrapassado!`);
            return false;
        }
    ...
    adicionarItem(nome, preco, quantidade = 1) {
        if (preco <= 0 || quantidade <= 0) {
            console.log("Preço e quantidade devem ser positivos!");
            return false;
        }
        ...
        if (this.#validarAdicao(precoTotal)) {
            ...
            console.log(`${quantidade} x ${nome} adicionado(s) ao carrinho!`);
            return true;
        }
